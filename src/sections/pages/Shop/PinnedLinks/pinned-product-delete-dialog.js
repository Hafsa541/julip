...
const PinnedProductDeleteDialog = ({ dialog, handleDelete }) => {
        ...
        <Box>
          <FormControl sx={{ m: 1, width: 500 }}>
            <Typography fontWeight={500} fontSize={17} color="black" align="center">
              Are You sure you want to delete this pinned product?This cannot be undone.
            </Typography>
          </FormControl>
        </Box>
      </DialogContent>
...
export default PinnedProductDeleteDialog;
PinnedProductDeleteDialog.propTypes = {
