...
const AboutSocialLinksDeleteDialoge = ({ dialog, handleDelete }) => {
  console.log('Social Delete Dialoge called');
...
export default AboutSocialLinksDeleteDialoge;
AboutSocialLinksDeleteDialoge.propTypes = {
